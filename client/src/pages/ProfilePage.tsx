...
function ProfilePage({ onLogout }: any) {
  ...
  const [favoritePlatform, setFavoritePlatform] =
    useState(user.favoritePlatform || "");
          ...
          <img
            src={
              searchedUser.profileImage
                ? `http://localhost:3000${searchedUser.profileImage}`
                : "/images/dummy-profile-blue.png"
            }
          ...
          <img
            src={
              request.sender?.profileImage
                ? `http://localhost:3000${request.sender.profileImage}`
                : "/images/dummy-profile-blue.png"
            }
